...
from models.MMPNRMNet import build_net
...
if __name__ == '__main__':
    ...
    # Directories
    parser.add_argument('--model_name', default='MMPNRMNet', type=str)
    parser.add_argument('--data_dir', type=str, default='data')
    parser.add_argument('--data_dir1', type=str, default='data1')
    ...
    # Test
    parser.add_argument('--test_model', type=str, default='results/MMPNRMNet/weights/model_100.pkl')
