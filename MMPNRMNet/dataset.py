...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', type=str, default=r'D:\MMPNRMNet\data1\train\BR')
    parser.add_argument('--train_GT_path', type=str, default=r'D:\MMPNRMNet\data1\train\GT')
    parser.add_argument('--valid_path', type=str, default=r'D:\MMPNRMNet\data1\valid\BR')
    parser.add_argument('--valid_GT_path', type=str, default=r'D:\MMPNRMNet\data1\valid\GT')
    parser.add_argument('--test_path', type=str, default=r'D:\MMPNRMNet\data1\test\BR')
    parser.add_argument('--test_GT_path', type=str, default=r'D:\MMPNRMNet\data1\test\GT')
