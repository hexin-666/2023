...
if __name__ == '__main__':
    ...
    # data path
    parser.add_argument('--origin_data_path', type=str, default='./c_r_end_end')
    parser.add_argument('--origin_GT_path', type=str, default='./c_t_end')
    
    parser.add_argument('--train_path', type=str, default=r'D:\MIMO-UNet-main\data1\train\BR')
    parser.add_argument('--train_GT_path', type=str, default=r'D:\MIMO-UNet-main\data1\train\GT')
    parser.add_argument('--valid_path', type=str, default=r'D:\MIMO-UNet-main\data1\valid\BR')
    parser.add_argument('--valid_GT_path', type=str, default=r'D:\MIMO-UNet-main\data1\valid\GT')
    parser.add_argument('--test_path', type=str, default=r'D:\MIMO-UNet-main\data1\test\BR')
    parser.add_argument('--test_GT_path', type=str, default=r'D:\MIMO-UNet-main\data1\test\GT')
